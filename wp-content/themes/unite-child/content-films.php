...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
        ...
        <hr>
        <?php
		echo __('Country: '); the_terms( $post->ID, 'country', '', ' , ' );
		?>
        <hr>

        <?php
            echo __('Genre: '); the_terms( $post->ID, 'genre', '', ' , ' );
        ?>
        <hr>

        <?php
            echo __('Ticket Price: ') . get_post_meta($post->ID, 'ticket_price', TRUE);
        ?>
        <hr>

        <?php
            echo __('Release Date: ') . get_post_meta($post->ID, 'release_date', TRUE);
        ?>
        <hr>
